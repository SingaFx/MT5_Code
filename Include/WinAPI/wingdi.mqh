...
int          GetICMProfileW(HANDLE hdc,uint &buf_size,string filename);
...
int          GetTextExtentExPointI(HANDLE hdc,ushort &str,int str,int max_extent,int &fit,int &dx[],SIZE &size);
...
int          GetTextFaceW(HANDLE hdc,int c,string name);
