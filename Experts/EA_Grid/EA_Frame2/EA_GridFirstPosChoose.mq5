...
#include <strategy_czj\strategyGrid\GridFrame2\GridFirstPositionChoose.mqh>
...
int OnInit()
  {
//---
   CGridFirstPositionChoose *strategy=new CGridFirstPositionChoose();
   strategy.ExpertName("CGridFirstPositionChoose");
