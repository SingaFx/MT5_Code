...
#include <strategy_czj\strategyFibonacci\FibonacciSignalImprove.mqh>
...
input ENUM_TIMEFRAMES Inp_ma_tf=PERIOD_H4;
input int Inp_ma_period=200;
input double Inp_lots_ma_ceof=2.0;
...
int OnInit()
  {
//---
   CFibonacciSignalImprove *strategy= new CFibonacciSignalImprove();
   strategy.ExpertName("CFibonacciSignalImprove");
   ...
   strategy.SetMaParameters(Inp_ma_tf,Inp_ma_period,Inp_lots_ma_ceof);
